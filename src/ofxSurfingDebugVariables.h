...
//TODO:
//+ add monitor extra variables on update
...
private:
	...
	//show external param
	//bool bShowGui;
	ofParameter<bool> bShowGui{ "SHOW DEBUG", true };
public:
	static ofParameter<bool>& getParamGui() {
		singletonGenerate();
...
private:
	...
	//TODO:
	//draw extra lines per frame, not subscribed as usual at setup...
private:
	bool bExtraInfo = false;
	string extraMessages;
public:
	void addExtraMessage();
};
